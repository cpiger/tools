...
flags = [
    #'-Wall',
    #  '-target=i686-pc-windows-msvc18.00.40629',
    ...
    #
    # combaseapi.h "IUnknown" is undefined # interface IUnknown;// ADD THIS LINE HERE
    # '-std=c++11', #'auto' return without trailing return type; deduced return types are a C++14 extension
    '-x', 'c',
    '-x', 'c++',
